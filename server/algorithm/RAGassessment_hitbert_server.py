...
class PDFTokenizer:
    def __init__(self, language='en'):
        ...
        if language == 'zh':
            ...
            self.tokenizer = BertTokenizer.from_pretrained('bert-base-chinese')  # 中文模型
            self.model = BertModel.from_pretrained('bert-base-chinese')
        else:
            self.tokenizer = BertTokenizer.from_pretrained('bert-base-uncased')  # 英文模型
...
def calculate_similarity():
    ...
    # 输出到日志，说明来源
    logging.info(f"来自 hitbert_server 的计算结果:\n{table}\n")
