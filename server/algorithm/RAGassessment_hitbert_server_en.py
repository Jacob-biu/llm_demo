...
class PDFTokenizer:
    def __init__(self):
        # 替换为英文的 BertTokenizer 和 BertModel
        self.tokenizer = BertTokenizer.from_pretrained('bert-base-uncased')  # 更换为英文的 BERT 模型
...
def calculate_similarity():
    ...
    # 英文文本不需要复杂的分词，只需要简单处理
    reference_sentences = [ref.split() for ref in reference_texts]
    ...
    # 输出到日志，说明来源
    logging.info(f"来自 hitbert_server_en 的计算结果:\n{table}\n")
